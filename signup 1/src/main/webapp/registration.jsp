...
<body>
  <input type="hidden" id="status" value="<%=request.getAttribute("status") %>">
			...
			<div class="container">
				<div class="signup-content">
					...
					<div class="signup-image">
						<figure>
							<img src="images/logo2.jpg" alt="sing up image">
						</figure>
	...
	else if(status=="invalidre_pass")
	{
	swal("both passwords are not matched")
	}
	else if(status=="invalidpwd")
	{
	swal("please enter password")
	}
	else if(status=="inavlidmobile")
		{
		swal("please enter contact number")
		}
	else if (status=="invalidlength")
		{
		swal("number range is more than 10")
		}
	</script>
